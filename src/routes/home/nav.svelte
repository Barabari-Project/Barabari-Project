<script>
    ...
    const navItems = [
        { name: "Get Mentorship", href: "/candidate" },
        { name: "Be a Mentor", href: "/mentor" },
...
<style lang="scss">
    ...
    .nav > .nav-links > a::after {
        background: //
            radial-gradient(circle at 20% 50%, #0006 0%, #0000 20%),
            radial-gradient(circle at 40% 50%, #0006 0%, #0000 30%),
            radial-gradient(circle at 60% 50%, #0006 0%, #0000 30%),
            radial-gradient(circle at 80% 50%, #0006 0%, #0000 20%);
        content: " ";
        position: absolute;
        top: 0;
        left: 0;
